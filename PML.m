...
%             % LDDR6 coefficients (not alternating scheme)
            pml.b1 = 0.1158488;
            pml.b2 = 0.3728769;
            pml.b3 = 0.7379536;
            pml.b4 = 0.5798110;
            ...
            pml.krhostorage = zeros(6,pml.NN);
        ...
        for m=1:pml.ylen
            for l=1:pml.xlen
                ...
                pml.rho(idx) = pml.rhostorage(1,idx) + pml.dt...
                    * ( pml.b1 * pml.krhostorage(1,idx)...
                    + pml.b2 * pml.krhostorage(2,idx)...
                    + pml.b3 * pml.krhostorage(3,idx)...
                    + pml.b4 * pml.krhostorage(4,idx)...
                    + pml.b5 * pml.krhostorage(5,idx)...
                    + pml.b6 * pml.krhostorage(6,idx) ); % LDDRK6
                ...
                pml.u(idx) = pml.ustorage(1,idx) + pml.dt...
                    * ( pml.b1 * pml.kustorage(1,idx)...
                    + pml.b2 * pml.kustorage(2,idx)...
                    + pml.b3 * pml.kustorage(3,idx)...
                    + pml.b4 * pml.kustorage(4,idx)...
                    + pml.b5 * pml.kustorage(5,idx)...
                    + pml.b6 * pml.kustorage(6,idx) ); % LDDRK6
                ...
                pml.v(idx) = pml.vstorage(1,idx) + pml.dt...
                    * ( pml.b1 * pml.kvstorage(1,idx)...
                    + pml.b2 * pml.kvstorage(2,idx)...
                    + pml.b3 * pml.kvstorage(3,idx)...
                    + pml.b4 * pml.kvstorage(4,idx)...
                    + pml.b5 * pml.kvstorage(5,idx)...
                    + pml.b6 * pml.kvstorage(6,idx) ); % LDDRK6
                ...
                pml.p(idx) = pml.pstorage(1,idx) + pml.dt...
                    * ( pml.b1 * pml.kpstorage(1,idx)...
                    + pml.b2 * pml.kpstorage(2,idx)...
                    + pml.b3 * pml.kpstorage(3,idx)...
                    + pml.b4 * pml.kpstorage(4,idx)...
                    + pml.b5 * pml.kpstorage(5,idx)...
                    + pml.b6 * pml.kpstorage(6,idx) ); % LDDRK6
                pml.q3(idx) = pml.q3storage(1,idx) + pml.dt...
                    * ( pml.b1 * pml.vstorage(1,idx)...
                    + pml.b2 * pml.vstorage(2,idx)...
                    + pml.b3 * pml.vstorage(3,idx)...
                    + pml.b4 * pml.vstorage(4,idx)...
                    + pml.b5 * pml.vstorage(5,idx)...
                    + pml.b6 * pml.vstorage(6,idx) ); % LDDRK6
                pml.q4(idx) = pml.q4storage(1,idx) + pml.dt...
                    * ( pml.b1 * pml.pstorage(1,idx)...
                    + pml.b2 * pml.pstorage(2,idx)...
                    + pml.b3 * pml.pstorage(3,idx)...
                    + pml.b4 * pml.pstorage(4,idx)...
